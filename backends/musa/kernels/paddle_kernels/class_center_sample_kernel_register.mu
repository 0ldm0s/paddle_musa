...
#define curandState murandState
#define curand_init murand_init
#define curand murand
...
void ClassCenterSampleKernel(const Context& dev_ctx,
  ...
  if (nranks > 1) {
    ...
    comm_ctx->AllReduce(
        &num_classes_per_device, num_classes_per_device, phi::ccl::CCLReduceOp::SUM, stream);
