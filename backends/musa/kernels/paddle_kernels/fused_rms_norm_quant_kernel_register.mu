...
#else
#define GPU(str) musa##str
#define GPUMultiProcessorCount musaDevAttrMultiProcessorCount
#define GPUMaxSharedMemoryPerBlockOptin musaDevAttrMaxSharedMemoryPerBlockOptin
#endif
...
#else
  musaError_t err = musaFuncGetAttributes(&attr, func);
#endif
  if (err != GPU(Success)) {
    return err;
  }
